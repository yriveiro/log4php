...
class LoggerLayoutTTCC extends LoggerLayout
{
     ...
     * @param bool $threadPrinting
     */
    public function setThreadPrinting(bool $threadPrinting)
    {
        $this->setBoolean('threadPrinting', $threadPrinting);
    }

    /**
     * @return bool Returns value of the <b>ThreadPrinting</b> option.
     */
     ...
     * @param bool $contextPrinting
     */
    public function setContextPrinting(bool $contextPrinting)
    {
     ...
     * This is true by default.
     * @param bool $microSecondsPrinting
     */
    public function setMicroSecondsPrinting(bool $microSecondsPrinting)
    {
