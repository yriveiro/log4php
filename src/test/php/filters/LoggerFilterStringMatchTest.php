...
class LoggerFilterStringMatchTest extends TestCase
{
    ...
    public function testDecideAccept()
    {
        ...
        $eventWarn2 = new LoggerLoggingEvent("LoggerAppenderEchoTest", new Logger("TEST"), LoggerLevel::getLevelWarning(), "xyz");
