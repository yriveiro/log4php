...
class LoggerLayoutTTCCTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $event = new LoggerLoggingEvent(LoggerLayoutTTCC::class, new Logger("TEST"), LoggerLevel::getLevelError(), "testmessage");
    ...
    {
        $event = new LoggerLoggingEvent(LoggerLayoutXml::class, new Logger("TEST"), LoggerLevel::getLevelWarn(), "testmessage");
